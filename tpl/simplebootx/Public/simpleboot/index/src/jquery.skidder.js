...
(function($, window, document, undefined) {
  ...
  var Skidder = {
    ...
    setSlideshowHeight: function(newMaxHeight) {
      ...
      self.$elem.add(self.$wrapper).add(self.$slides).add(self.$viewport.find('.skidder-clickelement')).css('height', newMaxHeight);
      
      // set viewport height;
      self.options.offsetHeight ? self.$elem.add(self.$viewport).css('height', newMaxHeight+self.options.offsetHeight) : self.$elem.add(self.$viewport).css('height', newMaxHeight);
    },
